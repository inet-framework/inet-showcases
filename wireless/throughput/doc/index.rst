...
function of nominal bitrate in a 802.11g network.
...
nominal bitrate because of protocol overhead like preamble, physical and
...
reduced by using block acknowledgement and frame aggregation. When block
acknowledgement is used, multiple data frames can be acknowledged with a
single block acknowledgement frame (instead of ACKing each data frame
