...
The example simulation uses the :ned:`QosClassifier` module.
...
First, let's examine the end-to-end delay:

.. figure:: delay_nonqos.png
   :width: 100%
   :align: center

In the non-QoS case, the end-to-end delay vector data points for the four access
...
When it is already filled up, the curve starts to fluctuate. The UDP applications
...
Here is a part of the QoS jitter chart:
 ...
 category are sent consequtively. The packets are generated every 0.25 and 1 ms,
 ...
 don't have the chance to be sent consequtively. Also, there is no horizontal line
